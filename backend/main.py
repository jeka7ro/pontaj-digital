...
from app.api import (
    ...
    admin_leaves, admin_tasks, fleet_fuel, fleet_km, fleet_reports, vehicle_cleaning,
    admin_deliveries
)
...
app.include_router(vehicle_cleaning.router, prefix="/api")
app.include_router(admin_deliveries.router, prefix="/api")
