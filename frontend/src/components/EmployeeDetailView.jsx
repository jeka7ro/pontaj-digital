...
import { ArrowLeft, MapPin, Phone, Mail, Calendar, Clock, Package, Car, Loader2, Award, Home, Activity, ShieldAlert, Zap, Thermometer, Wrench, CheckCircle2, BarChart3, Flame, FileText, Trash2, Upload, File, Download, X, Paperclip, Star } from 'lucide-react'
...
export default function EmployeeDetailView({ user, onBack, onExport }) {
    ...
    const TABS = [
        ...
        { id: 'evaluations', label: 'Evaluări / Rating', icon: Star },
    ]
                ...
                <div className="px-4 pt-4 pb-3 flex items-start gap-4">
                    ...
                    <div className="flex flex-col gap-1 mt-0.5 min-w-0">
                        <div className="flex flex-wrap items-center gap-2">
                            ...
                            {user.overall_rating && (
                                <span className="inline-flex items-center gap-1 bg-amber-50 dark:bg-amber-900/30 text-amber-600 dark:text-amber-500 px-1.5 py-0.5 rounded text-[10px] font-bold border border-amber-100 dark:border-amber-800 shrink-0">
