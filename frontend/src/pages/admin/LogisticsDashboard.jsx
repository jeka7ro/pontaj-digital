    ...
    const filteredCategories = [
        {
            ...
            items: [
                { path: '/logistica/warehouse', icon: Package, label: t('nav.warehouse', 'Magazie') },
                { path: '/logistica/fleet', icon: Truck, label: t('nav.fleet') },
                { path: '/logistica/material-requests', icon: PackageSearch, label: 'Necesar Materiale' },
            ]
        },
        {
            id: 'operations',
            label: 'Operațiuni',
            items: [
                { path: '/logistica/sites', icon: Building2, label: t('nav.sites') },
            ]
        },
        {
            id: 'support',
            label: 'Suport & Alerte',
            items: [
                { path: '/logistica/complaints', icon: MessageSquareWarning, label: 'Sesizări', badge: openComplaintsCount },
            ]
        }
    ]

    const [expandedCategories, setExpandedCategories] = useState({ logistics: true })
            ...
            <div className="flex-1 flex flex-col min-w-0 relative">
                ...
                <header className={`h-20 bg-slate-900 border-b border-white/10 px-6 flex items-center justify-between sticky top-0 z-40 text-white shadow-sm transition-colors shadow-slate-900/10`}>
                    <div className="flex items-center gap-4">
                         <span className={`font-bold text-lg hidden sm:block tracking-tight text-white/90`}>Portal Logistică</span>
                    </div>
                    ...
                    <div className="flex items-center gap-5">
                        ...
                        <div className="flex items-center gap-2">
                           ...
                           <button onClick={() => navigate('/logistica/complaints')} className={`p-2.5 rounded-full transition-colors relative text-slate-300 hover:text-white hover:bg-white/10`} title="Sesizări Noi">
                           ...
                           <button className={`p-2.5 rounded-full transition-colors relative text-slate-300 hover:text-white hover:bg-white/10`} onClick={() => navigate('/logistica/notifications')}>
